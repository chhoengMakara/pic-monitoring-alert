...
class Database{
	 ...
	 * Database class
	 */
	private $db_host = "172.168.10.60";  // Change as required
	private $db_user = "birt_db";  // Change as required
	private $db_pass = "Ibirt@2022";  // Change as required
	private $db_name = "cbs_report";	// Change as required
